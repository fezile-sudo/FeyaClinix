...
export class Reports
    ...
    this.subscriptions.add(
      ...
      this.appointmentService.appointments$.subscribe({
          ...
          next: appointments => {
            ...
            this.updateAppointmentCards(appointments);


            this.updateDoctorPerformance();
    ...
    this.subscriptions.add(
      ...
      this.patientService.patients$.subscribe({
          ...
          next: patients => {
            ...
            this.newPatients = patients.filter(
                patient => {
            ...
            this.buildPatientGrowth(patients);
  ...
  private updateDoctorPerformance(): void {
    ...
    this.doctorPerformance =
      this.doctors.map(
        doctor => {
          ...
          const appointmentCount = this.allAppointments.filter(
              appointment =>
    ...
    if (filters.fromDate) {
      ...
      filteredAppointments =
        filteredAppointments.filter(
          appointment =>
            new Date(appointment.date) >= fromDate);
        ...
        body:
          this.allAppointments.map(
            appointment => [
              ...
              this.getDoctorName(appointment.doctorId),
  ...
  exportExcel(): void {
    ...
    const rows = this.allAppointments.map(
        appointment => ({

          Patient: this.getPatientName(appointment.patientId),

          Doctor: this.getDoctorName(appointment.doctorId),
